 ...
 * existing layout.mjs. (In the original satus integration, a WCAG AA contrast
 * gate additionally validated every sync.)
 *
...
const STYLES = join(HERE, '..', 'styles') // styles/
...
async function run() {
  ...
  console.log(
    '  Generated CSS: css/root.css, css/theme.css, css/typography.css'
  )
}
